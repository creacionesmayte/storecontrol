...
function FindProduct({ addorder, allpro, setAllPro, ...props }) {
	...
	useEffect(() => {
		async function pro_method() {
			...
			// 	if(Status) {
			// 		await axios.get("https://storecontrolserver-production-1e18.up.railway.app/product").then(async (item1) => {
		...
		// 					await axios.post('https://storecontrolserver-production-1e18.up.railway.app/ordermaster/new', ord)
		// 						.then(async (item1) => {
		// 							for(let i=0; i<product_save.length; i++) {
		// 								product_save[i].Order_id = item1.data.Order_id
		// 							}
		// 							await axios.post('https://storecontrolserver-production-1e18.up.railway.app/orderproduct/new', product_save)
		// 								.then(async (item2) => {
		// 									for(let i=0; i<product_save.length; i++) {
		...
		// 										await axios.put('https://storecontrolserver-production-1e18.up.railway.app/product/quantity', req_data)
		...
		// 								// 			axios.post("https://storecontrolserver-production-1e18.up.railway.app/notification/new",{
		...
		// 							await axios.delete(`https://storecontrolserver-production-1e18.up.railway.app/ordermaster/delete/${it.Order_id}`)
		// 							await axios.delete(`https://storecontrolserver-production-1e18.up.railway.app/orderproduct/delete/${it.order_product[0].Order_pro_id}`)
		// 							.then(async item => {
		// 								await axios.get('https://storecontrolserver-production-1e18.up.railway.app/ordermaster')
		// 									.then(async prod => {
		// 										let months_data = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]
		...
		// 							})
		// 							await axios.delete(`https://storecontrolserver-production-1e18.up.railway.app/orderproduct/delete/${val.Order_pro_id}`)
		// 								.then(async item => {
		// 									await axios.get('https://storecontrolserver-production-1e18.up.railway.app/ordermaster')
		// 										.then( async prod => {
		// 											let months_data = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]
