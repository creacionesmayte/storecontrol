...
export const store_SalesActivity = async (naming, Status, Sales_Activity, allsalesactivity) => {
    if(Sales_Activity.length === 0) {
        if(Status) {
            await axios.get('https://storecontrolserver-production-a0c4.up.railway.app/salesactivity')
                .then(async item => {
                    ...
                    if(con === undefined) {
                        ...
                        main_data.push(data)
                        await axios.post('https://storecontrolserver-production-a0c4.up.railway.app/salesactivity/new', data)
                        ...
                        if(window.desktop) {
                            ...
                            await window.api.getAllData("Sales_Activity").then(async (item2) => {
                                if(item2.Sales_Activity === undefined) {
                                    ...
                                    await axios.post('https://storecontrolserver-production-a0c4.up.railway.app/salesactivity/new', another_data[another_data.length - 1])
                                }
                            })
                        }
                    } else {
...
export const store_Products = async (naming, Status, Products, allproduct, setAllPro, Sales_Activity, allorders, allsalesactivity) => {
    if(Products.length === 0) {
        if(Status) {
            await axios.get("https://storecontrolserver-production-a0c4.up.railway.app/product").then(async (item) => {
                    ...
                    await window.api.getAllData("Products").then(async (item2) => {
                        await window.api.getAllData("Orders_Returns").then(async (order_ret) => {
                            if(order_ret.Orders_Returns) {
                                ...
                                order_ret.Orders_Returns.forEach(async (ret) => {
                                    await axios.put('https://storecontrolserver-production-a0c4.up.railway.app/product/quantity', {Product_id: ret.Product_id, Stock: ret.Stock})
                                    ...
                                    console.log(ret)
                                    if(ret.del) {
                                        await axios.delete(`https://storecontrolserver-production-a0c4.up.railway.app/ordermaster/delete/${ret.order.Order_id}`)
                                    } else {
                                        await axios.put(`https://storecontrolserver-production-a0c4.up.railway.app/ordermaster/price`, {
                                            Order_id: ret.order.Order_id,
                                            Total_price: ret.order.Total_price
                                        })
                                    }
                                    await axios.delete(`https://storecontrolserver-production-a0c4.up.railway.app/orderproduct/delete/${ret.val.Order_pro_id}`)
                                    .then(async item => {
                                        await axios.get('https://storecontrolserver-production-a0c4.up.railway.app/ordermaster')
                                            .then(async prod => {
                                                let months_data = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]
                                                ...
                                                await axios.put('https://storecontrolserver-production-a0c4.up.railway.app/salesactivity/day', {
                                                    Sales_id: Sales_data.Sales_id,
                                                    ...Sales_data
                                                })
                                                await axios.get('https://storecontrolserver-production-a0c4.up.railway.app/salesactivity').then(async item3 => {
                        ...
                        item2.Products.forEach(async function (pro, index) {
                            ...
                            if (!Object.keys(pro).includes('createdAt')) {
                                ...
                                await axios.post("https://storecontrolserver-production-a0c4.up.railway.app/product/new", convert_data).then(async (item) => {
                                ...
                                await axios.put('https://storecontrolserver-production-a0c4.up.railway.app/product/edit', edit_val).then(res => {
                        ...
                        await window.api.getAllData("Products_Returns").then(async (product_ret) => {
                            if(product_ret.Products_Returns) {
                                ...
                                product_ret.Products_Returns.forEach(async (ret) => {
                                    await axios.delete(`https://storecontrolserver-production-a0c4.up.railway.app/product/delete/${ret.Product_id}`);
                                    await axios.get("https://storecontrolserver-production-a0c4.up.railway.app/product").then(async (item) => {
                        ...
                        //         }
                        //         if (flag === 0) {
                        //             await axios.delete(`https://storecontrolserver-production-a0c4.up.railway.app/product/delete/${alldata[h].Product_id}`);
                        //             await axios.get("https://storecontrolserver-production-a0c4.up.railway.app/product").then(async (item) => {
                        //                 console.log(`${naming} -> Delete`)
                        //                 var alldata = item.data
                        //                 if (alldata.length > 0) {
...
export const store_Category = async (naming, Status, CategoryAdd, category) => {
    if(CategoryAdd.length === 0) {
        if(Status) {
            await axios.get("https://storecontrolserver-production-a0c4.up.railway.app/category").then(async (item) => {
                    ...
                    await window.api.getAllData("CategoryAdd").then(async (item2) => {
                        item2.CategoryAdd.forEach(async function (cate) {
                            if (!Object.keys(cate).includes('createdAt')) {
                                await axios.post('https://storecontrolserver-production-a0c4.up.railway.app/category/new', cate).then(async (item3) => {
                        ...
                        //             await axios.delete(`https://storecontrolserver-production-a0c4.up.railway.app/category/delete/${c.Category_id}`)
                    ...
                    await window.api.getAllData("Category_Returns").then(async (category_ret) => {
                        if(category_ret.Category_Returns) {
                            category_ret.Category_Returns.forEach(async (ret) => {
                                await axios.delete(`https://storecontrolserver-production-a0c4.up.railway.app/category/delete/${ret.Category_id}`)
...
export const store_Desposito = async (naming, Status, DepositoAdd, deposito) => {
    if (DepositoAdd.length === 0) {
        if (Status) {
            await axios.get("https://storecontrolserver-production-a0c4.up.railway.app/deposito").then(async (item) => {
...
export const store_Expenses = async (naming, Status, Expenses, allexp) => {
    if(Expenses.length === 0){
        if(Status) {
            await axios.get("https://storecontrolserver-production-a0c4.up.railway.app/expense").then(async (item) => {
                    ...
                    await window.api.getAllData("Expenses").then(async (item2) => {
                        item2.Expenses.forEach(async function (exp, index) {
                            if(!Object.keys(exp).includes('ExpenseId')) {
                                await axios.post("https://storecontrolserver-production-a0c4.up.railway.app/expense/new", exp)
                                .then(async (item3) => {
                                    var m = item.data;
                                    m.push(item3.data);
                            ...
                            if(item.data.length === item2.Expenses.length) {
                                item2.Expenses.forEach(async (new_exp) => {
                                    ...
                                    if(flag1 === 1) {
                                        ...
                                        await axios.put("https://storecontrolserver-production-a0c4.up.railway.app/expense/edit", new_exp).catch(err => console.log(err))
                                        await axios.get("https://storecontrolserver-production-a0c4.up.railway.app/expense").then(async (item3) => {
                            ...
                            //             await axios.delete(`https://storecontrolserver-production-a0c4.up.railway.app/expense/delete/${ex.ExpenseId}`).then(async dele => {
                            //                 await axios.get("https://storecontrolserver-production-a0c4.up.railway.app/expense").then(async (item7) => {
                    ...
                    await window.api.getAllData("Expenses_Returns").then(async (expense_ret) => {
                        if(expense_ret.Expenses_Returns) {
                            expense_ret.Expenses_Returns.forEach(async (ret) => {
                                await axios.delete(`https://storecontrolserver-production-a0c4.up.railway.app/expense/delete/${ret.Expense_id}`).then(async dele => {
                                    await axios.get("https://storecontrolserver-production-a0c4.up.railway.app/expense").then(async (item7) => {
                                        item7.data.sort(function (d1, d2) {
                                            return new Date(d2.createdAt) - new Date(d1.createdAt);
                                        });
...
export const store_Expensecat = async (naming, Status, Expensecat, expense_category) => {
    if (Expensecat.length === 0) {
        if(Status) {
            await axios.get("https://storecontrolserver-production-a0c4.up.railway.app/expensecat").then(async (item) => {
                    ...
                    await window.api.getAllData("Expensecat").then(async (item2) => {
                        item2.Expensecat.forEach(async function (exp_cate, index) {
                            if(!Object.keys(exp_cate).includes('CategoryExpense_id')) {
                                await axios.post("https://storecontrolserver-production-a0c4.up.railway.app/expensecat/new", exp_cate).then(async (item3) => {
...
export const store_NotifyMaster = async (naming, Status, Notific, notify) => {
    if(Notific.length === 0){
        if(Status) {
            await axios.get("https://storecontrolserver-production-a0c4.up.railway.app/notification").then(async item => {
                    ...
                    await window.api.getAllData("Notification").then(async (item2) => {
                        item2.Notification.forEach(async notify_data => {
                            if(notify_data.Notify_id === undefined) {
                                await axios.post("https://storecontrolserver-production-a0c4.up.railway.app/notification/new",{
